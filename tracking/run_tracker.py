...
def run_mdnet(img_list, init_bbox, gt=None, savefig_dir='', display=False):
    ...
    #traffic_line_bb.train(0, target_bbox)
	...
	if success:
        ...
        if display or savefig:
            ...
            #tl_bb = traffic_line_bb.predict(i)
            rect2.set_xy(tl_bb[:2])
            rect2.set_width(tl_bb[2])
            rect2.set_height(tl_bb[3])
